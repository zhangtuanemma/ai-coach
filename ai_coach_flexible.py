...
【重要】陈宁案例 - 员工群内反馈问题处理失当（负面教材）：
事件：2025年7月，员工在群里询问订单安排，站长未及时回应。次日，事业部代理总经理陈宁在群里回应，但沟通方式失当（直接怼员工"你昨天做啥了？公司怎么不关心你了？"），引发员工抵触情绪。后续采取停单、移出群组等措施进一步激化矛盾，导致员工投诉到服务台。
...
2. 约员工吃饭道歉：
   ...
   - 问"讲完之后心里有没有舒服一点？"
   - 问员工有什么诉求："只要不过分都可以"
   - 道歉三步：我道歉、陈宁当面道歉、站会上公开承认错误
   - 最后才讲陈宁家里的困难（不是为他开脱）
   - 员工主动提出拥抱和解

处罚：陈宁被记过处分，职级下调一级，全公司通报批评，年度绩效不高于B级，取消评优资格，3-6个月不得晋升。

核心教训：
- **先倾听，不要解释**：让对方说完，哪怕20分钟
- **找认可的点**：哪怕都是错的，也要找一个认可的点
- **换角色思考**：如果你是员工/客户，你会怎么想？
- **眼神交流**：看着对方，让他感受到被理解
- **情绪要释放**：有情绪就让他释放出来，他讲多了自己就知道问题了
- **不要立即对立**：不要把员工反馈当成麻烦

正确的群内回应方式：
"@员工，非常感谢你的反馈，我今天才看到信息，很抱歉现在才回复。你反馈的这个问题很好，我私下找你详聊。也希望你能写一下建议给到我们。"
...
- 使命：让服务和被服务的人都感到幸福
- 愿景：十万年薪、百万就业、千万家庭
- 价值观：快乐、进步、感动；诚信在任何时候都是对的；不占别人便宜
- 目的：践行企业文化，让优秀服务者被看见、被认可，传递榜样火种
- 入围标准：年度服务精神奖、0投诉服务时长6年以上等
- 档位：Y10（年薪10万）、Y12（年薪12万）、Y15（年薪15万）

投诉事故处理流程：
- 使用simba事件系统记录问题发生的原因、解决过程及方案
- 发布事件要点：排重、选择正确的事件类型、提取客户信息、按标准模板填写
- 常见事件类型：客户投诉、保险理赔等

现场理赔权益：
- 目的：让服务者有担当（不逃避、不推诿），让客户更满意、更信任
- 核心理念：不满意我可以重新做、我打坏的东西我负责
- 给员工支持权限，减少侥幸心理，鼓励变成有担当的服务者
- 为服务者和被服务者提供情绪价值：认可、信任、尊重

好慷服务法与服务执照：
- 服务违规五类（严重程度递增）：服务标准、服务行为、服务事故、服务安全、服务禁忌
- 服务执照：持证上岗，出单要"领证"
- 站长六大须知：罚款缴纳、违规复训、执照刷新、豁免规则、申诉权力、执照吊销

年年发政策：
- 必备资格：年度出单量≥500单，工龄≥1年，且次年3月25日仍在职
- 质量目标：0投诉、0事故
- 过程指标：固定客户取消数、三安事故数
- 客户认可奖：固定越久，奖金越高（依据客户固定员工的累计服务小时数）
